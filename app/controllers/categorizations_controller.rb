class CategorizationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorization.save
        format.html { redirect_to categorization_url(@categorization), notice: "Categorization was successfully created." }
  ...
  def update
    respond_to do |format|
      if @categorization.update(categorization_params)
        format.html { redirect_to categorization_url(@categorization), notice: "Categorization was successfully updated." }
  ...
  private
    ...
    def categorization_params
      params.require(:categorization).permit(:article_id, :category_id)
    end
end
